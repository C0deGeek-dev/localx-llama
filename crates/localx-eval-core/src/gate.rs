//! Provenance + safety gating for benchmark artifacts.
//!
//! Two benchmark-integrity invariants:
//! 1. **Provenance.** A gate card is tagged `Live` or `Offline`. An offline
...
/// The gating fields of one benchmark artifact: where it came from, whether
/// safety held, and the capability delta.
...
impl GateCard {
    /// Whether this artifact may satisfy a gate that requires a live run.
    ///
